...
import styles from '../css/PL_GameSchedule.module.scss'
...
function PL_GameSchedule () {
    ...
    useEffect(() => {
        axiosInstance.get('/PL/matchSchedule', {
    ...
    //                                 </div>
    //
    //                                 {/* <div className={cx("thirdline")}> */}
    //                                 {/*    <p className={cx("date")}> [{formattedTime}] */}
    //                                 {/*    </p> */}
    //
    //                                 {/* </div> */}
    //
    ...
    //                                     className={cx('status')}>{statusText}</p>
    //                             </div>
    //                         </div>
    //                     )
    //                 }
        ...
        <div>
            {
                data && data.length ? (
                    ...
                    : (
                        <p className={cx('outerTag')}>7일 이내 경기가 없습니다.</p>
                    )
            }
        </div>
    )
...
export default PL_GameSchedule
