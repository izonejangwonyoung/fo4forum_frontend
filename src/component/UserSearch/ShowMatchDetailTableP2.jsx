...
// function ShowMatchDetailTableP2 (props) {
...
//         console.log('ddddddd', selectedRow, selectedTableNumber)
//         setShowModal(true)
//     }
//     // const player1Nickname = matchInfo && matchInfo.length > 0 ? matchInfo[0].nickname : ''
//     const player2Nickname = matchInfo[1].nickname
//     matchInfo[1].player.sort((a, b) => b.spPosition - a.spPosition)
//
//     return (
//         <>
//
...
//                     <div>
//                         {/* <tr> */}
//                         {/*    <td colSpan={5} style={{ fontWeight: 'bold' }}>플레이어 이름: {player2Nickname}</td> */}
//                         {/* </tr> */}
//
//                     </div>
//
//                     {matchInfo[1].player && matchInfo[1].player.map((it, indexk) => {
//                     //    return (
//                     // <>
...
//                     //        })</>);
//
//                         const playerInfo = [player2Nickname] // player 정보 배열
...
//                         const firstThreeDigits = convertspId ? String(convertspId.id).substr(0, 3) : ''
//                         const convertSeason = SeasonJson.find((data) => data.seasonId == firstThreeDigits)
//                         const spIdName = convertspId ? convertspId.name : 'API 업데이트가 되지 않았습니다. '
//                         // const seasonImg = convertSeason ? convertSeason.seasonImg : 'API 업데이트가 되지 않았습니다. '
//                         const seasonImg = convertSeason ? convertSeason.seasonImg : `${convertSeason}`
...
//                                     <td className={cx('td-seasonimg')}><img src={seasonImg}/></td>
...
// }
//
// export default ShowMatchDetailTableP2
...
function ShowMatchDetailTableP2 (props) {
    ...
    // const player1Nickname = matchInfo && matchInfo.length > 0 ? matchInfo[0].nickname : ''
    const player1Nickname = matchInfo[1].nickname
    console.log('table2의 데이터를 찍어보겠습니다. ', matchInfo)
    matchInfo[1].player.sort((a, b) => b.spPosition - a.spPosition)
